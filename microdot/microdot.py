...
class Microdot:
    ...
    def find_route(self, req):
        ...
        p = ''
        s = None
        for route_methods, route_pattern, route_handler, url_prefix, subapp \r
                in self.url_map:
    ...
    def get_request_handlers(self, req, attr, local_first=True):
        ...
        local_handlers = getattr(req.subapp, attr + '_handlers') \r
            if req and req.subapp else []
        return local_handlers + handlers if local_first \r
        ...
        if req:
            if req.content_length > req.max_content_length:
                ...
                try:
                    ...
                    handler = None
                    res = None
                    if req.subapp and exc.__class__ in \r
